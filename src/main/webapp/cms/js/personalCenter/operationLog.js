layui.config({
 ...
 var app = table.render({
    ...
    ,skin:"nob"
    ,cols: [[ //表头
      {field: 'id',title: 'id', sort: true, toolbar: '#indexTpl',fixed: 'left',width: 70}
         ,{field: 'username', title: '用户名', }
         ,{field: 'city', title: '手机号', }
         ,{field: 'wealth', title: '操作时间', }
         ,{field: 'wealth', title: '登陆ip', }
         ,{field: 'classify', title: '登录功能菜单', }
         ,{field: 'logins', title: '操作', }
         ,{field: 'wealth', title: '详细内容', }
    ]]
  });
  //起止时间
    laydate.render({
